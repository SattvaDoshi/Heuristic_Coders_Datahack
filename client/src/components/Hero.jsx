...
const Hero = () => {
  return (
    <div className="mt-10 h-screen md:flex md:flex-row flex flex-col items-center text-white">
      <div className="flex flex-col gap-4 md:w-3/5 w-11/12 h-full justify-center pl-16 bg-blue-700 bg-opacity-60 rounded-md">
